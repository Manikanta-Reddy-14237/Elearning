...
export default function TSignIn() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post(`https://elearningbackend-jg1p54tf9-manikantas-projects-f78ee616.vercel.app/teachlogin`, payload)
      .then((response) => {
  ...
  const handleSignup = (event) => {
    ...
    axios
      .post('https://elearningbackend-jg1p54tf9-manikantas-projects-f78ee616.vercel.app/teachsignup', payload)
      .then((response) => {
