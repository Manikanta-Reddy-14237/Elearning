...
export default function SSignIn() {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post('https://elearningbackend-git-main-manikantas-projects-f78ee616.vercel.app/stdlogin', payload)
      .then((response) => {
  ...
  const handleSignup = (event) => {
    ...
    axios
      .post('https://elearningbackend-git-main-manikantas-projects-f78ee616.vercel.app/stdsignup', payload)
      .then((response) => {
