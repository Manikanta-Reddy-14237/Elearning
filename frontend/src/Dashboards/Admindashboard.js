    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const token = localStorage.getItem('authToken');
                const studentData = await axios.get('http://elearning-khaki.vercel.app/Studentsdata', {
                    headers: {
                        Authorization: `Bearer ${token}`, // Set the Authorization header
                    },
                });

                const teacherData = await axios.get('http://elearning-khaki.vercel.app/Teachersdata', {
                    headers: {
                        Authorization: `Bearer ${token}`, // Set the Authorization header
                    },
                });
